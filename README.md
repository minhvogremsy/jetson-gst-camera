...
V4L2 cameras
```bash
sudo ./aarch64/bin/video-viewer /dev/video0
sudo ./aarch64/bin/video-viewer /dev/video0 output.mp4 # save output stream to MP4 file (H.264 by default)
sudo ./aarch64/bin/video-viewer /dev/video0 rtp://192.168.12.51:1234 # broadcast output stream over RTP to <remote-ip>
sudo ./aarch64/bin/video-viewer --input-width=1920 --input-height=1080 /dev/video0
sudo ./aarch64/bin/video-viewer --input-width=1920 --input-height=1080 --input-codec=h264 /dev/video0 # Possible decoder codec options are --input-codec=h264, h265, vp8, vp9, mpeg2, mpeg4, mjpeg
...
```
  ...
  --input-save=FILE      path to video file for saving the input stream to disk# Camera Streaming and Multimedia
